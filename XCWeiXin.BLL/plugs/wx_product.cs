...
namespace XCWeiXin.BLL
{
	...
	{
		private readonly XCWeiXin.DAL.wx_product dal=new XCWeiXin.DAL.wx_product();
		public wx_product()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(XCWeiXin.Model.wx_product model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_product model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_product GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_product> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_product> DataTableToList(DataTable dt)
		{
			List<XCWeiXin.Model.wx_product> modelList = new List<XCWeiXin.Model.wx_product>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XCWeiXin.Model.wx_product model;
