...
namespace XCWeiXin.BLL
{
	...
	{
		private readonly XCWeiXin.DAL.wx_dati_base dal=new XCWeiXin.DAL.wx_dati_base();
		public wx_dati_base()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_dati_base> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_dati_base> DataTableToList(DataTable dt)
		{
			List<XCWeiXin.Model.wx_dati_base> modelList = new List<XCWeiXin.Model.wx_dati_base>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XCWeiXin.Model.wx_dati_base model;
