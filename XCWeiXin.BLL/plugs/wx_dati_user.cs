...
namespace XCWeiXin.BLL
{
	...
	{
		private readonly XCWeiXin.DAL.wx_dati_user dal=new XCWeiXin.DAL.wx_dati_user();
		public wx_dati_user()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_dati_user> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_dati_user> DataTableToList(DataTable dt)
		{
			List<XCWeiXin.Model.wx_dati_user> modelList = new List<XCWeiXin.Model.wx_dati_user>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XCWeiXin.Model.wx_dati_user model;
