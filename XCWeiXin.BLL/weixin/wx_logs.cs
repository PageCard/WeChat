...
namespace XCWeiXin.BLL
{
	...
	{
		private readonly XCWeiXin.DAL.wx_logs dal=new XCWeiXin.DAL.wx_logs();
		public wx_logs()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(XCWeiXin.Model.wx_logs model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_logs model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_logs GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_logs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_logs> DataTableToList(DataTable dt)
		{
			List<XCWeiXin.Model.wx_logs> modelList = new List<XCWeiXin.Model.wx_logs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XCWeiXin.Model.wx_logs model;
