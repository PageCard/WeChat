...
namespace XCWeiXin.BLL
{
    ...
    {
        private readonly XCWeiXin.DAL.wx_requestRule dal = new XCWeiXin.DAL.wx_requestRule();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(XCWeiXin.Model.wx_requestRule model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(XCWeiXin.Model.wx_requestRule model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public XCWeiXin.Model.wx_requestRule GetModel(int id)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<XCWeiXin.Model.wx_requestRule> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<XCWeiXin.Model.wx_requestRule> DataTableToList(DataTable dt)
        {
            List<XCWeiXin.Model.wx_requestRule> modelList = new List<XCWeiXin.Model.wx_requestRule>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                XCWeiXin.Model.wx_requestRule model;
