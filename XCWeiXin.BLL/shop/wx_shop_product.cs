...
namespace XCWeiXin.BLL
{
	...
	{
		private readonly XCWeiXin.DAL.wx_shop_product dal=new XCWeiXin.DAL.wx_shop_product();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(XCWeiXin.Model.wx_shop_product model)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_shop_product> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_shop_product> DataTableToList(DataTable dt)
		{
			List<XCWeiXin.Model.wx_shop_product> modelList = new List<XCWeiXin.Model.wx_shop_product>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XCWeiXin.Model.wx_shop_product model;
