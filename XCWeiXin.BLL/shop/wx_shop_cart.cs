...
namespace XCWeiXin.BLL
{
	...
	{
		private readonly XCWeiXin.DAL.wx_shop_cart dal=new XCWeiXin.DAL.wx_shop_cart();
		public wx_shop_cart()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(XCWeiXin.Model.wx_shop_cart model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_shop_cart model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_shop_cart GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_shop_cart> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XCWeiXin.Model.wx_shop_cart> DataTableToList(DataTable dt)
		{
			List<XCWeiXin.Model.wx_shop_cart> modelList = new List<XCWeiXin.Model.wx_shop_cart>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XCWeiXin.Model.wx_shop_cart model;
