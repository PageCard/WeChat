...
namespace XCWeiXin.Model
{
	...
	public partial class wx_book_product
	{
        ...
        private List<wx_book_productAttr_value> _attrs;

        /// <summary>
        /// 属性值列表
        /// </summary>
        public List<wx_book_productAttr_value> attrs
        {
            set { _attrs = value; }
            get { return _attrs; }
        }

        private List<wx_book_sku> _skulist;
        /// <summary>
        /// 商品sku列表
        /// </summary>
        public List<wx_book_sku> skulist
        {
            set { _skulist = value; }
            get { return _skulist; }
        }
