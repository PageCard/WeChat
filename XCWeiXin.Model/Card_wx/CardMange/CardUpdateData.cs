...
namespace XCWeiXin.Model.Card_wx.CardMange
{
    ...
    /// 团购券数据
    /// </summary>
    public class Card_groupon : BaseUpdateInfo
    {
   ...
   /// </summary>
    ...
    public class Card_general_coupon : BaseUpdateInfo
    {
    ...
    /// 代金券
    /// </summary>
    public class Card_cash : BaseUpdateInfo
    {
    ...
    /// 折扣券
    /// </summary>
    public class Card_discount : BaseUpdateInfo
    {
