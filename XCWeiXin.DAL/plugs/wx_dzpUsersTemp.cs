...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_dzpUsersTemp
	{
		...
		public XCWeiXin.Model.wx_dzpUsersTemp GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_dzpUsersTemp model=new XCWeiXin.Model.wx_dzpUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_dzpUsersTemp DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_dzpUsersTemp model=new XCWeiXin.Model.wx_dzpUsersTemp();
			if (row != null)
			{
        ...
        /// 得到一个对象实体
        /// </summary>
        public XCWeiXin.Model.wx_dzpUsersTemp getModelByAidOpenid(int actId, string openid)
        {
