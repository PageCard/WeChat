...
namespace XCWeiXin.DAL
{
    ...
    public partial class wx_diancai_dingdan_caiping
    {
        ...
        public XCWeiXin.Model.wx_diancai_dingdan_caiping GetModel(int id)
        {
            ...
            XCWeiXin.Model.wx_diancai_dingdan_caiping model = new XCWeiXin.Model.wx_diancai_dingdan_caiping();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XCWeiXin.Model.wx_diancai_dingdan_caiping DataRowToModel(DataRow row)
        {
            XCWeiXin.Model.wx_diancai_dingdan_caiping model = new XCWeiXin.Model.wx_diancai_dingdan_caiping();
            if (row != null)
            {
