...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_ggkUsersTemp
	{
		...
		public XCWeiXin.Model.wx_ggkUsersTemp GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_ggkUsersTemp model=new XCWeiXin.Model.wx_ggkUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_ggkUsersTemp DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_ggkUsersTemp model=new XCWeiXin.Model.wx_ggkUsersTemp();
			if (row != null)
			{
        ...
        /// 得到一个对象实体
        /// </summary>
        public XCWeiXin.Model.wx_ggkUsersTemp getModelByAidOpenid(int actId, string openid)
        {
