...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_diancai_dingdan_manage
	{
		...
		public XCWeiXin.Model.wx_diancai_dingdan_manage GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_diancai_dingdan_manage model=new XCWeiXin.Model.wx_diancai_dingdan_manage();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_diancai_dingdan_manage DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_diancai_dingdan_manage model=new XCWeiXin.Model.wx_diancai_dingdan_manage();
			if (row != null)
			{
