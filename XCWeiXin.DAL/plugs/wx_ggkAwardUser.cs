...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_ggkAwardUser
	{
		...
		public XCWeiXin.Model.wx_ggkAwardUser GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_ggkAwardUser model=new XCWeiXin.Model.wx_ggkAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_ggkAwardUser DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_ggkAwardUser model=new XCWeiXin.Model.wx_ggkAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public XCWeiXin.Model.wx_ggkAwardUser getZJinfoByOpenid(int actId, string openid)
        {
