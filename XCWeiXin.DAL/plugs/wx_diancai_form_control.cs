...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_diancai_form_control
	{
		...
		public XCWeiXin.Model.wx_diancai_form_control GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_diancai_form_control model=new XCWeiXin.Model.wx_diancai_form_control();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_diancai_form_control DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_diancai_form_control model=new XCWeiXin.Model.wx_diancai_form_control();
			if (row != null)
			{
