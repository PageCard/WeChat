...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_sq_piclist
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(XCWeiXin.Model.wx_sq_piclist model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_sq_piclist model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_sq_piclist GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_sq_piclist model=new XCWeiXin.Model.wx_sq_piclist();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_sq_piclist DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_sq_piclist model=new XCWeiXin.Model.wx_sq_piclist();
			if (row != null)
			{
