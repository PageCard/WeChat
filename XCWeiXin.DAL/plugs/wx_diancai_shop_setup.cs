...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_diancai_shop_setup
	{
		...
		public XCWeiXin.Model.wx_diancai_shop_setup GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_diancai_shop_setup model=new XCWeiXin.Model.wx_diancai_shop_setup();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_diancai_shop_setup DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_diancai_shop_setup model=new XCWeiXin.Model.wx_diancai_shop_setup();
			if (row != null)
			{
