...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_purchase_customer
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public XCWeiXin.Model.wx_purchase_customer GetModel(int Id)
        {
            ...
            XCWeiXin.Model.wx_purchase_customer model = new XCWeiXin.Model.wx_purchase_customer();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XCWeiXin.Model.wx_purchase_customer DataRowToModel(DataRow row)
        {
            XCWeiXin.Model.wx_purchase_customer model = new XCWeiXin.Model.wx_purchase_customer();
            if (row != null)
            {
