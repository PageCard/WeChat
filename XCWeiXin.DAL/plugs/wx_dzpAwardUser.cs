...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_dzpAwardUser
	{
		...
		public XCWeiXin.Model.wx_dzpAwardUser GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_dzpAwardUser model=new XCWeiXin.Model.wx_dzpAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_dzpAwardUser DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_dzpAwardUser model=new XCWeiXin.Model.wx_dzpAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public XCWeiXin.Model.wx_dzpAwardUser getZJinfoByOpenid(int actId, string openid)
        {
