...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_diancai_blacklist
	{
        ...
        public XCWeiXin.Model.wx_diancai_blacklist GetModel(int id)
        {
            ...
            XCWeiXin.Model.wx_diancai_blacklist model = new XCWeiXin.Model.wx_diancai_blacklist();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XCWeiXin.Model.wx_diancai_blacklist DataRowToModel(DataRow row)
        {
            XCWeiXin.Model.wx_diancai_blacklist model = new XCWeiXin.Model.wx_diancai_blacklist();
            if (row != null)
            {
