...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_diancai_form_result
	{
		...
		public XCWeiXin.Model.wx_diancai_form_result GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_diancai_form_result model=new XCWeiXin.Model.wx_diancai_form_result();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_diancai_form_result DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_diancai_form_result model=new XCWeiXin.Model.wx_diancai_form_result();
			if (row != null)
			{
