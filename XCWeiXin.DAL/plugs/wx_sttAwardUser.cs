...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_sttAwardUser
	{
		...
		public XCWeiXin.Model.wx_sttAwardUser GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_sttAwardUser model=new XCWeiXin.Model.wx_sttAwardUser();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_sttAwardUser DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_sttAwardUser model=new XCWeiXin.Model.wx_sttAwardUser();
			if (row != null)
			{
        ...
        /// 该用户的中奖信息
        /// </summary>
        public XCWeiXin.Model.wx_sttAwardUser getZJinfoByOpenid(int actId, string openid)
        {
