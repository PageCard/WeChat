...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_ucard_store_fendian
	{
		...
		public XCWeiXin.Model.wx_ucard_store_fendian GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_ucard_store_fendian model=new XCWeiXin.Model.wx_ucard_store_fendian();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_ucard_store_fendian DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_ucard_store_fendian model=new XCWeiXin.Model.wx_ucard_store_fendian();
			if (row != null)
			{
