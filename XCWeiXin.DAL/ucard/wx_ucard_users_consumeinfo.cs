...
namespace XCWeiXin.DAL
{
    ...
    public partial class wx_ucard_users_consumeinfo
    {
        ...
        public XCWeiXin.Model.wx_ucard_users_consumeinfo GetModel(int id)
        {
            ...
            XCWeiXin.Model.wx_ucard_users_consumeinfo model = new XCWeiXin.Model.wx_ucard_users_consumeinfo();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XCWeiXin.Model.wx_ucard_users_consumeinfo DataRowToModel(DataRow row)
        {
            XCWeiXin.Model.wx_ucard_users_consumeinfo model = new XCWeiXin.Model.wx_ucard_users_consumeinfo();
            if (row != null)
            {
