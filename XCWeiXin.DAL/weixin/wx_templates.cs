...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_templates
	{
		...
		public XCWeiXin.Model.wx_templates GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_templates model=new XCWeiXin.Model.wx_templates();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_templates DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_templates model=new XCWeiXin.Model.wx_templates();
			if (row != null)
			{
