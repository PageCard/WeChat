...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_response_BaseData
	{
        ...
        public bool updata(XCWeiXin.Model.wx_response_BaseData model)
        {
            ...
            {
                new SqlParameter("@reponseContent",SqlDbType.VarChar,20000),
                new SqlParameter("@id",SqlDbType.Int,4) };
            paemeter[0].Value = model.reponseContent;
            paemeter[1].Value = model.id;
		...
		public XCWeiXin.Model.wx_response_BaseData GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_response_BaseData model=new XCWeiXin.Model.wx_response_BaseData();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_response_BaseData DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_response_BaseData model=new XCWeiXin.Model.wx_response_BaseData();
			if (row != null)
			{
