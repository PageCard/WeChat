...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_userweixin
	{
        ...
        /// <returns></returns>
        public bool Update_userinfo(int wid, string openid, string nickname, string sex, string language, string province, string city, string country, string head, string subscribe, string subscribe_time, string remark, string groupid)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            parameters[8].Value = country;
            parameters[9].Value = head;
            parameters[10].Value = subscribe_time;
        ...
        /// <param name="country"></param>
        /// <param name="head"></param>
        /// <param name="subscribe">是否订阅公众号表示</param>
        /// <param name="subscribe_time">订阅时间</param>
        /// <param name="remark">备注</param>
        /// <param name="groupid">分组id</param>
        /// <returns></returns>
        public int Insert_userinfo(int wid, string openid, string nickname, string sex, string language, string province, string city, string country, string head, string subscribe, string subscribe_time, string remark, string groupid)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into wx_Userinfo(");
            strSql.Append("wid,openid,subscribe,nickname,sex,language,city,province,country,headimgul,subscribe_time,remark,groupid)");
            ...
            SqlParameter[]parameters={
                      ...
                      new SqlParameter("@province",SqlDbType.VarChar,100),
                      new SqlParameter("@country",SqlDbType.VarChar,100),
                      new SqlParameter("@headimgul",SqlDbType.VarChar,200),
                      new SqlParameter("@subscribe_time",SqlDbType.DateTime),
                      new SqlParameter("@remark",SqlDbType.VarChar,300),
                      new SqlParameter("@groupid",SqlDbType.Int,4)};
            parameters[0].Value = wid;
        ...
        /// <returns></returns>
        public bool Upadata_Kefu(XCWeiXin.Model.wx_userweixin model)
        {
            StringBuilder strsql = new StringBuilder();
        	...
        	new SqlParameter("@extInt", SqlDbType.Int,4),
            new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = model.extInt;
		...
		public XCWeiXin.Model.wx_userweixin GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_userweixin model=new XCWeiXin.Model.wx_userweixin();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_userweixin DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_userweixin model=new XCWeiXin.Model.wx_userweixin();
			if (row != null)
			{
