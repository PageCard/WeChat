...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_requestRuleContent
	{
		...
		public XCWeiXin.Model.wx_requestRuleContent GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_requestRuleContent model=new XCWeiXin.Model.wx_requestRuleContent();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_requestRuleContent DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_requestRuleContent model=new XCWeiXin.Model.wx_requestRuleContent();
			if (row != null)
			{
        ...
        {
            IList<XCWeiXin.Model.wx_requestRuleContent> rcList = new List<Model.wx_requestRuleContent>();
            ...
            while (sr.Read())
            {
                model = new XCWeiXin.Model.wx_requestRuleContent();
                model.rContent = sr["rContent"].ToString();
                model.rContent2 = sr["rContent2"].ToString();
