...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_book_product
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_book_product"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_book_product");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_book_product ");
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_product DataRowToModel(DataRow row)
		{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wx_book_product ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_book_product T ");
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        StringBuilder strSql = new StringBuilder();
                        strSql.Append("update wx_book_product set ");
					...
					new SqlParameter("@id", SqlDbType.Int,4)};
                        ...
                        #region  //添加/修改相册
                        new wx_book_albums().DeleteList(conn, trans, model.albums, model.id);
                        if (model.albums != null)
                        {
                            StringBuilder strSql3;
                            foreach (Model.wx_book_albums modelt in model.albums)
                            {
                                ...
                                else
                                {
                                    ...
                                    strSql3.Append("productId,thumb_path,original_path,remark,add_time,wid)");
                                    strSql3.Append(" values (");
                                    strSql3.Append("@productId,@thumb_path,@original_path,@remark,@add_time,@wid)");
                                    SqlParameter[] parameters3 = {
					                        new SqlParameter("@productId", SqlDbType.Int,4),
                        ...
                        strDeleteSql.Append("delete from wx_book_productAttr_value where productId=@productId;");
                        strDeleteSql.Append("delete from wx_book_sku where productId=productId");
                        SqlParameter[] parameters4 = {
				        	new SqlParameter("@productId", SqlDbType.Int,4)
		            	};
                        ...
                        if (model.attrs != null)
                        {
                            ...
                            foreach (Model.wx_book_productAttr_value modelt in model.attrs)
                            {
                                ...
                                strSql5.Append("insert into  wx_book_productAttr_value(");
                        ...
                        if (model.skulist != null)
                        {
                            ...
                            foreach (Model.wx_book_sku modelt in model.skulist)
                            {
                                ...
                                strSql6.Append("insert into  wx_book_sku(");
        ...
        public bool Delete(int id)
        {
            ...
            strSql1.Append("delete from wx_book_productAttr_value ");
            ...
            strSql2.Append("delete from wx_book_sku ");
            ...
            strSql3.Append("delete from wx_book_albums ");
            ...
            strSql5.Append("delete from wx_book_comment ");
            ...
            strSql6.Append("delete from wx_book_cart ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update wx_book_product set " + strValue);
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select  link_url='',(select top 1 original_path from dbo.wx_book_albums where  productId=p.id) as productpic,* from wx_book_product p ");
            strSql.Append(" where  wid=" + wid);
            if (category_id > 0)
            {
                strSql.Append(" and categoryId in(select id from  wx_book_category where class_list like '%," + category_id + ",%')");
