...
namespace XCWeiXin.DAL
{
	...
	/// </summary>
	public partial class wx_bookpayment_wxpay
	{
        public wx_bookpayment_wxpay()
		{}
		#region  BasicMethod
		...
		public XCWeiXin.Model.wx_payment_wxpay GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_payment_wxpay model=new XCWeiXin.Model.wx_payment_wxpay();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_payment_wxpay DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_payment_wxpay model=new XCWeiXin.Model.wx_payment_wxpay();
			if (row != null)
			{
