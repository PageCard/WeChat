...
namespace XCWeiXin.DAL
{
	...
	/// 数据访问类:wx_book_brand
	/// </summary>
	public partial class wx_book_brand
	{
        public wx_book_brand()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_book_brand"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_book_brand");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(XCWeiXin.Model.wx_book_brand model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_book_brand(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_book_brand model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_book_brand set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_book_brand ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_brand GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,wid,bName,logo,companyUrl,companyName,remark,sort_id,createDate from wx_book_brand ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			XCWeiXin.Model.wx_book_brand model=new XCWeiXin.Model.wx_book_brand();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_brand DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_book_brand model=new XCWeiXin.Model.wx_book_brand();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wx_book_brand ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_book_brand T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wx_book_brand";
