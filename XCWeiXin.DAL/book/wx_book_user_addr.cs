...
{
	/// <summary>
	/// 数据访问类:wx_book_user_addr
	/// </summary>
	public partial class wx_book_user_addr
	{
		public wx_book_user_addr()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_book_user_addr"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_book_user_addr");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(XCWeiXin.Model.wx_book_user_addr model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_book_user_addr(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_book_user_addr model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_book_user_addr set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_book_user_addr ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_user_addr GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,wid,openid,province,city,area,addrDetail,tel,jiedao,contractPerson,createDate from wx_book_user_addr ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			XCWeiXin.Model.wx_book_user_addr model=new XCWeiXin.Model.wx_book_user_addr();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_user_addr DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_book_user_addr model=new XCWeiXin.Model.wx_book_user_addr();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wx_book_user_addr ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetOpenidAddr(string openid,int wid)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,wid,openid,province,city,area,addrDetail,tel,jiedao,contractPerson,createDate ");
            strSql.Append(" FROM wx_book_user_addr where openid=@openid and wid=@wid ");
        ...
        public DataSet GetOpenidAddrName(string openid, int wid)
        {
            ...
            strSql.Append(" FROM wx_book_user_addr a where openid=@openid and wid=@wid ");
