...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_book_setting
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_book_setting"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_book_setting");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(XCWeiXin.Model.wx_book_setting model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_book_setting(");
			strSql.Append("wid,bookName,copyright,logo,bgPic,tel,addr,createDate,extInt,extStr)");
			strSql.Append(" values (");
			strSql.Append("@wid,@bookName,@copyright,@logo,@bgPic,@tel,@addr,@createDate,@extInt,@extStr)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@wid", SqlDbType.Int,4),
					new SqlParameter("@bookName", SqlDbType.VarChar,200),
            ...
            if (model.albums != null)
            {
                ...
                foreach (Model.wx_book_albums modelt in model.albums)
                {
                    ...
                    strSql2.Append("booksettingId,thumb_path,original_path,remark,add_time,wid)");
                    strSql2.Append(" values (");
                    strSql2.Append("@booksettingId,@thumb_path,@original_path,@remark,@add_time,@wid)");
                    SqlParameter[] parameters2 = {
					    new SqlParameter("@booksettingId", SqlDbType.Int,4),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_book_setting model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_book_setting set ");
            ...
            #region  //添加/修改相册          
                        ...
                        new wx_book_albums().DeleteBookSetting(model.albums, model.id);
                        if (model.albums != null)
                        {
                            ...
                            foreach (Model.wx_book_albums modelt in model.albums)
                            {
                                ...
                                if (modelt.id > 0)
                                {
                                    ...
                                    strSql3.Append("booksettingId=@booksettingId,");
                                ...
                                else
                                {
                                    ...
                                    strSql3.Append("booksettingId,thumb_path,original_path,remark,add_time,wid)");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_book_setting ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_setting GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,wid,bookName,copyright,logo,bgPic,tel,addr,createDate,extInt,extStr from wx_book_setting ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_setting DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_book_setting model=new XCWeiXin.Model.wx_book_setting();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,wid,bookName,copyright,logo,bgPic,tel,addr,createDate,extInt,extStr ");
			strSql.Append(" FROM wx_book_setting ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,wid,bookName,copyright,logo,bgPic,tel,addr,createDate,extInt,extStr ");
			strSql.Append(" FROM wx_book_setting ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_book_setting T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wx_book_setting";
