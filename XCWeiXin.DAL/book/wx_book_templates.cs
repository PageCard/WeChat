...
{
	/// <summary>
	/// 数据访问类:wx_book_templates
	/// </summary>
	public partial class wx_book_templates
	{
        public wx_book_templates()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_book_templates"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_book_templates");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(XCWeiXin.Model.wx_book_templates model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_book_templates(");
			strSql.Append("tName,author,bookName,bookCode,createDate,version,forWxVersion,typeName,typeId,aboutPic,tFileName,degreeName,degreId,remark)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@bookCode", SqlDbType.VarChar,20),
			...
			parameters[3].Value = model.bookCode;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_book_templates model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_book_templates set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_book_templates ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_templates GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,tName,author,bookName,bookCode,createDate,version,forWxVersion,typeName,typeId,aboutPic,tFileName,degreeName,degreId,remark from wx_book_templates ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			XCWeiXin.Model.wx_book_templates model=new XCWeiXin.Model.wx_book_templates();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_templates DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_book_templates model=new XCWeiXin.Model.wx_book_templates();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,tName,author,bookName,bookCode,createDate,version,forWxVersion,typeName,typeId,aboutPic,tFileName,degreeName,degreId,remark ");
			strSql.Append(" FROM wx_book_templates ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,tName,author,bookName,bookCode,createDate,version,forWxVersion,typeName,typeId,aboutPic,tFileName,degreeName,degreId,remark ");
			strSql.Append(" FROM wx_book_templates ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_book_templates T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wx_book_templates";
        ...
        /// 通过wid获得微帐号对应的首页模版名称
        /// </summary>
        public string GetTemplatesFileNameByWid(string bookCode, int wid)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,tFileName from wx_book_templates  ");
            strSql.Append(" where bookCode=@bookCode and  id=(select tid from wx_book_templates_wcode where wid=@wid)");
            SqlParameter[] parameters = {
                    new SqlParameter("@bookCode", SqlDbType.VarChar,20),
