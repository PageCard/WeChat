...
namespace XCWeiXin.DAL
{
	...
	/// </summary>
	public partial class wx_bookpayment_type
	{
        public wx_bookpayment_type()
		{}
		#region  BasicMethod
		...
		public XCWeiXin.Model.wx_payment_type GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_payment_type model=new XCWeiXin.Model.wx_payment_type();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_payment_type DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_payment_type model=new XCWeiXin.Model.wx_payment_type();
			if (row != null)
			{
