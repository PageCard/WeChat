...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_book_cart
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "wx_book_cart"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from wx_book_cart");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(XCWeiXin.Model.wx_book_cart model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wx_book_cart(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_book_cart model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wx_book_cart set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wx_book_cart ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_cart GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,openid,wid,productId,skuId,skuInfo,totPrice,productNum,createDate from wx_book_cart ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			XCWeiXin.Model.wx_book_cart model=new XCWeiXin.Model.wx_book_cart();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_book_cart DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_book_cart model=new XCWeiXin.Model.wx_book_cart();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM wx_book_cart ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wx_book_cart T ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(@"select c.id,openid,wid,productId,skuId,skuInfo,totPrice,productNum,createDate,pr.productName,pr.shortDesc,pr.pic,pr.stock FROM wx_book_cart c left join (
select  id,productName,shortDesc,stock,(select top 1 original_path from wx_book_albums where productid=p.id) as pic from wx_book_product p 
