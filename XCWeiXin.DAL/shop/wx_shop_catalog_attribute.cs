...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_shop_catalog_attribute
	{
		...
		public XCWeiXin.Model.wx_shop_catalog_attribute GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_shop_catalog_attribute model=new XCWeiXin.Model.wx_shop_catalog_attribute();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_shop_catalog_attribute DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_shop_catalog_attribute model=new XCWeiXin.Model.wx_shop_catalog_attribute();
			if (row != null)
			{
