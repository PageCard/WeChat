...
namespace XCWeiXin.DAL
{
	...
	public partial class wx_shop_sku
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(XCWeiXin.Model.wx_shop_sku model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XCWeiXin.Model.wx_shop_sku model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_shop_sku GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_shop_sku model=new XCWeiXin.Model.wx_shop_sku();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_shop_sku DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_shop_sku model=new XCWeiXin.Model.wx_shop_sku();
			if (row != null)
			{
        ...
        /// 得到商品的配件列表
        /// </summary>
        public List<XCWeiXin.Model.wx_shop_sku> GetpSkuModelList(int productId)
        {
            List<XCWeiXin.Model.wx_shop_sku> pStuList = new List<Model.wx_shop_sku>();
            ...
            strSql.Append(" and  v.productId=@productId  order by a.sort_id asc");
            SqlParameter[] parameters = {
					new SqlParameter("@productId", SqlDbType.Int,4)
			};
