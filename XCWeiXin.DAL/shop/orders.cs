    ...
    public partial class orders
    {
        ...
        public int Add(Model.orders model)
        {
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@bookordertime", SqlDbType.DateTime),
            ...
            parameters[43].Value = model.bookorder_time;
            parameters[44].Direction = ParameterDirection.Output;
            ...
            return (int)parameters[44].Value;
        }
