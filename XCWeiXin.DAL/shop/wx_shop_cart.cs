	...
	public partial class wx_shop_cart
	{
		...
		public int Add(XCWeiXin.Model.wx_shop_cart model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@skuId", SqlDbType.VarChar,100),
					new SqlParameter("@skuInfo", SqlDbType.VarChar,1000),
		...
		public XCWeiXin.Model.wx_shop_cart GetModel(int id)
		{
			...
			XCWeiXin.Model.wx_shop_cart model=new XCWeiXin.Model.wx_shop_cart();
		...
		/// 得到一个对象实体
		/// </summary>
		public XCWeiXin.Model.wx_shop_cart DataRowToModel(DataRow row)
		{
			XCWeiXin.Model.wx_shop_cart model=new XCWeiXin.Model.wx_shop_cart();
			if (row != null)
			{
