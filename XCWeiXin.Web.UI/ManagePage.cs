...
namespace XCWeiXin.Web.UI
{
    public class ManagePage : System.Web.UI.Page
    {
        ...
        public bool IsAdminLogin()
        {
            ...
            {
                //检查Cookies
                string adminname = Utils.GetCookie("AdminName", "XCWeiXin");
                string adminpwd = Utils.GetCookie("AdminPwd", "XCWeiXin");
        ...
        public bool IsWeiXinCode()
        {
            ...
            {
                //检查Cookies
                string uweixinId = Utils.GetCookie("nowweixinId", "XCWeiXin");
                if (uweixinId != "")
                {
