<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="from_jujia.aspx.cs" Inherits="XCWeiXin.Web.hugongll.from_jujia" %>
...
<div class="list-block inset">
  <ul>
    ...
    <li>
      <div class="item-content">
        ...
        <div class="item-inner">
          <div class="item-input">
            <input type="text" style="font-size:1rem" placeholder="服务价格" value=<%=mony %>元/月 readonly  >
          </div>
        </div>
      </div>
    </li>
    ...
    <div class="toolbar">
     ...
     <div class="row no-gutter">
         <div class="col-33"><asp:HiddenField  ID="hid"  runat="server"/><asp:Label ID="lb1" CssClass="button button-big button-fill color-pink" runat="server"/></div>
  ...
  <script type="text/javascript">
      ...
      var point = new BMap.Point(103.88664515, 36.069886);
