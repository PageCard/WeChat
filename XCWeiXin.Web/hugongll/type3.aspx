<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="type3.aspx.cs" Inherits="XCWeiXin.Web.hugongll.type3" %>
     ...
     <center>病人护理合同</center>
      ...
      <table style="width: 100%;">
          ...
          <tr>
            ...
            <a href="#"  id="form1" data-popup=".popup-about" class="button button-big button-fill  open-3-modal" style="margin-top:-5px">立即预约</a>
       </div>
      ...
      <div class="view view-main toolbar-through">
        ...
        <div class="navbar">
          <div class="navbar-inner">
            ...
            <div class="center " style=" font-weight:100">居家护理_标准</div>
            <div class="right">
...
<div>
    <img style="width:100%;height:9rem" src="云家政素材/pp.jpg" /></div>
...
<div style="background-color:white; margin-top:0.4rem;">
      ...
      <table style="width:100%" class="fontd">
          <tr>
              <th class="fontds"><span class="axiba icon-jiantou spancolor"></span>生活完全自理的老年慢性病的患者</th>
              <th class="fontds"><span class="axiba icon-jiantou spancolor"></span>生活部分自理的人群</th>
          </tr>
          <tr>
              <th class="fontds"><span class="axiba icon-jiantou spancolor"></span>病情稳定，仍需卧床的患者</th>
              <th class="fontds"><span class="axiba icon-jiantou spancolor"></span>处于康复期的患者，遵医嘱协助康复锻炼</th>  
          </tr>
           <tr>
              <th class="fontds"><span class="axiba icon-jiantou spancolor"></span>需要生活照料的人群</th>
              <th class="fontds"><span class="axiba icon-jiantou spancolor"></span>针对中度/中度失能人群</th>  
          </tr>
  ...
  <script type="text/javascript">
   ...
   <script>
       $$('#form1').on('click', function () {
           ...
           window.location = "from_jujia.aspx?type=biaozhun";
       });
