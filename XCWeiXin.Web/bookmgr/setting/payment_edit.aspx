<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_edit.aspx.cs" Inherits="XCWeiXin.Web.bookmgr.setting.payment_edit" ValidateRequest="false" %>
        ...
        <div class="tab-content">
            ...
            <dl style="display: none;">
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*百分比的计算公式：预订总金额+(预订总金额*百分比)+配送费用=订单总金额</span>
                </dd>
            </dl>
            <dl style="display: none;">
                <dt>支付手续费</dt>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*一般来说，虚拟预订或者充值类需要立即发货，实体预订选择后台管理员点击发货</span>
                </dd>
            </dl>
