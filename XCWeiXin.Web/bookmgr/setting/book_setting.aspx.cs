...
namespace XCWeiXin.Web.bookmgr.setting
{
    public partial class book_setting : Web.UI.ManagePage
    {
        XCWeiXin.BLL.wx_book_setting bll = new XCWeiXin.BLL.wx_book_setting();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "修改预订设置"); //记录日志
                JscriptMsg("修改预订设置成功！", "book_setting.aspx", "Success");
            }
            catch
            {
                JscriptMsg("预订设置失败！", "", "Error");
            }
        }
