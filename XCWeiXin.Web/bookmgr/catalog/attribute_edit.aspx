<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_edit.aspx.cs" Inherits="XCWeiXin.Web.bookmgr.catalog.attribute_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="catalog_list.aspx" class="back"><i></i><span>返回预订类型列表</span></a>
            <a href="attribute_list.aspx?id=<%=catalogId %>" class="home"><i></i><span>预订属性管理</span></a>
            <i class="arrow"></i>
            <span>编辑预订属性</span>
        </div>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑预订属性</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="padding-right:20px;">
                                ...
                                <span>请预设属性值(一行代表一个属性值); 管理员在这里可预设多个属性值，以便于添加预订时从中选择一个。前台客户购物时,仅可以查看预订此项属性。 如为空，则可在添加预订时由管理员手工录入。</span>
