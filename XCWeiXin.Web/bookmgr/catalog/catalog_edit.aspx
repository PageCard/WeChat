<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="catalog_edit.aspx.cs" Inherits="XCWeiXin.Web.bookmgr.catalog.catalog_edit" %>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑预订类型</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*预订类型名称不能为空，长度限制在1-50个字符之间.</span>
                </dd>
            </dl>
