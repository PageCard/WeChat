...
namespace XCWeiXin.Web.bookmgr.catalog
{
    public partial class catalog_edit : Web.UI.ManagePage
    {
        private string action = MXEnums.ActionEnum.Add.ToString(); //操作类型

        wx_book_catalog clBll = new wx_book_catalog();
        ...
        private void ShowInfo(int id)
        {
            ...
            Model.wx_book_catalog catalog = clBll.GetModel(id);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            #region 赋值
            Model.wx_book_catalog catalog = new Model.wx_book_catalog();
            ...
            {  //新增
                ...
                AddAdminLog(MXEnums.ActionEnum.Add.ToString(), "添加预订类型，主键为" + id); //记录日志
                JscriptMsg("添加预订类型成功！", "catalog_list.aspx", "Success");
            }
            else
            {   //修改
                ...
                AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "修改预订类型，主键为" + id); //记录日志
                JscriptMsg("修改预订类型成功！", "catalog_list.aspx", "Success");
            }
