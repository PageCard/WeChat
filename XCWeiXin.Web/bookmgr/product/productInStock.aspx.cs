...
namespace XCWeiXin.Web.bookmgr.product
{
    public partial class productInStock : Web.UI.ManagePage
    {
        ...
        BLL.wx_book_product caBll = new BLL.wx_book_product();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(MXEnums.ActionEnum.Delete.ToString(), "删除预订信息" + sucCount + "条，失败" + errorCount + "条"); //记录日志
        ...
        protected void btnXiJia_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "上架出售中的预订"); //记录日志
            JscriptMsg("预订上架成功啦！", Utils.CombUrlTxt("productInStock.aspx", "category_id={0}&keywords={1}", this.category_id.ToString(), this.keywords), "Success");
