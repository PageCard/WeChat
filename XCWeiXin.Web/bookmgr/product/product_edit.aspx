<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_edit.aspx.cs" Inherits="XCWeiXin.Web.bookmgr.product.product_edit" ValidateRequest="false"  %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <a href="javascript:;" class="home"><i></i><span>编辑预订</span></a>
            ...
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li><a href="javascript:;" onclick="tabs(this);">预订描述</a></li>
                        <li><a href="javascript:;" onclick="tabs(this);">预订属性</a></li>
                        <li><a href="javascript:;" onclick="tabs(this);">预订相册</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
            <dl>
                ...
                <dd>
                  ...
                  <span class="red">如更改预订类型，则预订原来的属性就丢失。</span>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*预订名称，长度在1至25个字符之间.</span>
                </dd>
            </dl>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*如果您不输入预订货号，系统将自动生成一个唯一的货号。</span>
                </dd>
            </dl>
            ...
            <dl>
                <dt>单位</dt>
                <dd>
                    <asp:TextBox ID="txtunit" runat="server" CssClass="input small" datatype="*1-50" sucmsg=" " Text=""  nullmsg=" " ></asp:TextBox>
                    <span class="Validform_checktip">*/<a href="javascript:void 0" onclick="txtunit.value='件'">件</a>　<a href="javascript:void 0" onclick="txtunit.value='套'">套</a>　<a href="javascript:void 0" onclick="txtunit.value='组'">组</a></span>
                </dd>
            </dl>
            <dl>
                <dt>成本价</dt>
