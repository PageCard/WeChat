<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productInStock.aspx.cs" Inherits="XCWeiXin.Web.bookmgr.product.productInStock" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="javascript:;" class="home"><i></i><span>仓库中的预订</span></a>
        </div>
        <!--/导航栏-->
            ...
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li><a class="icon-btn add" href="product_add.aspx?frompage=productInStock.aspx" id="itemAddButton"><i></i><span>新增预订</span></a></li>
                        <li>
                            <asp:LinkButton ID="btnSave" runat="server" CssClass="save" OnClick="btnSave_Click"><i></i><span>保存排序</span></asp:LinkButton></li>
                         <li>
                            <asp:LinkButton ID="btnXiJia" runat="server" CssClass="folder" OnClick="btnXiJia_Click"><i></i><span>上架预订</span></asp:LinkButton></li>
