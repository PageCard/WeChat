<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_edit.aspx.cs" Inherits="XCWeiXin.Web.bookmgr.category.category_edit"  ValidateRequest="false"%>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="category_list.aspx" class="back"><i></i><span>返回预订分类</span></a>
            <i class="arrow"></i>
            <span>编辑预订分类</span>
        </div>
        ...
        <div class="content-tab-wrap" >
            <div id="floatHead" class="content-tab" >
                <div class="content-tab-ul-wrap" >
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑预订分类</a></li>
                      <li><a href="javascript:;" onclick="tabs(this);">扩展选项</a></li>
                       <li><a href="javascript:;" onclick="tabs(this);">分类焦点图片</a></li>
