<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bisai_list.aspx.cs" Inherits="XCWeiXin.Web.admin.sjb.bisai_list" %>
    ...
    <form id="form1" runat="server">
          ...
          <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="icon-btn add" href="bisai_edit.aspx?action=<%=XCWeiXin.Common.MXEnums.ActionEnum.Add %>&type=add&rcid=<%=richengid %>"  id="itemAddButton"><i></i><span>新增比赛</span></a></li>                       
