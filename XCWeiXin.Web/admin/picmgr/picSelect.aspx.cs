...
namespace XCWeiXin.Web.admin.picmgr
{
    public partial class picSelect : System.Web.UI.Page
    {
        XCWeiXin.BLL.wx_PicStore bll = new XCWeiXin.BLL.wx_PicStore();
        ...
        private void BindPic(string templates)
        {
            ...
            IList<XCWeiXin.Model.wx_PicStore> plist = bll.GetModelList("pictemplates='" + templates + "'");
            if (plist == null || plist.Count <= 0)
            {
                litPicStr.Text = "";
                return;
            }
            XCWeiXin.Model.wx_PicStore p = new XCWeiXin.Model.wx_PicStore();
