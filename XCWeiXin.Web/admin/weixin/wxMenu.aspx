<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wxMenu.aspx.cs" Inherits="XCWeiXin.Web.admin.weixin.wxMenu" %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <table border="0" class="innertable">
                                ...
                                <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtTop1Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                        ...
                        <td>
                            <table border="0" class="innertable">
                                ...
                                <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtTop2Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                        ...
                        <td>
                            <table border="0" class="innertable">
                                ...
                                <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtTop3Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                        ...
                        <td>
                            <table border="0" class="innertable">
                                ...
                                <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu11Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu21Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu31Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu12Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu22Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu32Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu13Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu23Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu33Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu14Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="td_titleName">url：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu14Url" runat="server" CssClass="txtNameUrl" 
                                           ></asp:TextBox></td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu24Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu34Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu15Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu25Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
                            ...
                            <table border="0" class="innertable">
                                <tr>
                                  ...
                                  <tr>
                                    <td class="td_titleName">类型：</td>
                                    <td>
                                        <asp:TextBox ID="txtMenu35Type" runat="server" CssClass="txtNameKey"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="td_titleName">key：</td>
                                    <td>
     ...
     scancode_waitmsg　　　扫码推事件且弹出“消息接收中”提示框
        ...
        <div class="page-footer" runat="server" id="div_gongju">
            <div class="btn-list">
                 ...
                 <asp:Button ID="Button3" runat="server" Text="备份菜单" CssClass="btn yellow" OnClick="btnAddMenu_Click" />
                 <asp:Button ID="Button2" runat="server" Text="提取备份菜单" CssClass="btn yellow" OnClick="btnBackMenu_Click" />
