...
namespace XCWeiXin.Web.admin.product
{
    public partial class product_sys_edit : Web.UI.ManagePage
    {
        private string action = MXEnums.ActionEnum.Add.ToString(); //操作类型

        XCWeiXin.BLL.wx_product_sys bll = new XCWeiXin.BLL.wx_product_sys();
        private int id = 0;
        ...
        private void ShowInfo(int id)
        {
            ...
            XCWeiXin.Model.wx_product_sys model = bll.GetModel(id);
