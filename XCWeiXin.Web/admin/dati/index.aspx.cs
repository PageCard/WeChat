...
namespace XCWeiXin.Web.admin.dati
{
    public partial class index : Web.UI.ManagePage
    {
        ...
        BLL.wx_dati_base datiBll = new BLL.wx_dati_base();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind(CombSqlTxt(keywords), "addtime desc,id desc");
            }
        }
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("dati_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("dati_page_size", _pagesize.ToString(), 14400);
                }
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(MXEnums.ActionEnum.Delete.ToString(), "删除题库信息" + sucCount + "条，失败" + errorCount + "条"); //记录日志
