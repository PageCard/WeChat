<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="XCWeiXin.Web.admin.users.user_audit" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new XCWeiXin.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
    <td><%#Eval("email")%></td>
