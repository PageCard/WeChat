...
namespace XCWeiXin.Web.shop
{
    ...
    public partial class so : ShopBasePage
    {
        ...
        override protected void OnInit(EventArgs e)
        {
            ...
            serverPath = MyCommFun.GetRootPath() + "/shop/templates/" + templateFileName + "/so.html";
            ...
            template.soStr = MyCommFun.RequestParam("sostr"); 
