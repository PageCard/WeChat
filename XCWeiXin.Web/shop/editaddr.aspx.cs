...
namespace XCWeiXin.Web.shop
{
    public partial class editaddr : ShopBasePage
    {
        ...
        private void EditAddr()
        {
            ...
            string isIndex = MyCommFun.QueryString("isindex");
            BLL.wx_shop_user_addr addrBll = new BLL.wx_shop_user_addr();
            List<XCWeiXin.Model.wx_shop_user_addr> addrlist = addrBll.GetOpenidAddr(openid, wid);
            XCWeiXin.Model.wx_shop_user_addr addr = new Model.wx_shop_user_addr();
            bool isAdd = true;
