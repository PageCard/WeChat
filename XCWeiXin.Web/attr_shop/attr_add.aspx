<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attr_add.aspx.cs" Inherits="XCWeiXin.Web.attr_shop.attr_add" %>
          ...
          <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                         <li><a href="javascript:;" onclick="tabs(this);" class="selected">商品大属性配置</a></li>
               ...
               <dl>       
                   <dt>所属大商品名称</dt>
                    <dd>
                        ...
                        <span class="Validform_title">商品属性名词必填</span>
                    </dd>
                </dl>  
