...
{
    public partial class sub_attr : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind(" min_attrid="+id+"", "sub_attrid desc");
            }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            this.rptList.DataSource = bll.GetListshop(this.pageSize, this.page, "sub_attrid", _strWhere, _orderby, out this.totalCount);
