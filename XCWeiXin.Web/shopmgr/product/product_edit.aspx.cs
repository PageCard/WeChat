...
namespace XCWeiXin.Web.shopmgr.product
{
    public partial class product_edit : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            XCWeiXin.Model.wx_shop_product model = spBll.GetModel(id);
          //  model.wid = wid;
            ...
            if (albumArr != null)
            {
                ...
                for (int i = 0; i < albumArr.Length; i++)
                {
                    ...
                    if (imgArr.Length == 3)
                    {
                        ...
                        {
                            ls.Add(new Model.wx_shop_albums { id = img_id, productId = id, original_path = imgArr[1], thumb_path = imgArr[2], remark = remarkArr[i], px = int.Parse(remarkArrpx[i]) });
                        }
                        else
                        {
