<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_edit.aspx.cs" Inherits="XCWeiXin.Web.shopmgr.category.category_edit"  ValidateRequest="false"%>
             ...
             <dl>
                ...
                <dd>
                    ...
                    <asp:TextBox ID="txtImgUrl" runat="server" CssClass="input normal"   />                     
                     <span class="Validform_checktip"><a href="/sui/css/demo/demo.html" target="_blank">查看所有字体图标</a></span>
