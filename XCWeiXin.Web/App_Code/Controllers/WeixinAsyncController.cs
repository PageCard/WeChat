...
namespace XCWeiXin.Web.App_Code.Controllers
{
    ...
    {
        public static readonly string Token = Config.Component_Token;//与微信公众账号后台的Token设置保持一致，区分大小写。
        public static readonly string EncodingAESKey =  Config.Component_EncodingAESKey;//与微信公众账号后台的EncodingAESKey设置保持一致，区分大小写。
        public static readonly string AppId = Config.Component_Appid;//与微信公众账号后台的AppId设置保持一致，区分大小写。
