...
namespace XCWeiXin.Web.App_Code.Controllers
{
    ...
    public class TenPayV3Controller : Controller
    {
        ...
        public static TenPayV3Info TenPayV3Info
        {
            get
            {
                ...
                {
                    _tenPayV3Info =
                        TenPayV3InfoCollection.Data["1339609701"];
                }
        ...
        public ActionResult Index(int productId = 0, int hc = 0)
        {
            ...
            var url = OAuthApi.GetAuthorizeUrl(TenPayV3Info.AppId, returnUrl, state, Senparc.Weixin.MP.OAuthScope.snsapi_userinfo);
        ...
        public ActionResult NativeNotifyUrl()
        {
            ...
            packageReqHandler.SetParameter("trade_type", Senparc.Weixin.MP.TenPayV3Type.NATIVE.ToString());
   ...
   <return_msg><![CDATA[{1}]]></return_msg>
        ...
        public ActionResult SendRedPack()
        {
            ...
            //设置package订单参数
            packageReqHandler.SetParameter("nonce_str", nonceStr);              //随机字符串
            packageReqHandler.SetParameter("wxappid", "wx57d365e74490cf2f");		  //公众账号ID
            packageReqHandler.SetParameter("mch_id", "1309832401");		  //商户号


            packageReqHandler.SetParameter("sub_appid", "wxfbd774ca1eabd17a");		  //商户号
            packageReqHandler.SetParameter("sub_mch_id", "1312583301");		  //商户号
            packageReqHandler.SetParameter("sub_openid", "oFo2HjiuEyhtCDbnFLxdhlQ5tRVA");

            packageReqHandler.SetParameter("mch_billno", mchbillno);                 //填入商家订单号
            packageReqHandler.SetParameter("send_name", "浩客");                 //红包发送者名称
            packageReqHandler.SetParameter("re_openid", "oFo2HjiuEyhtCDbnFLxdhlQ5tRVA");                 //接受收红包的用户的openId
            ...
            string sign = packageReqHandler.CreateMd5Sign("key", "hk80BEC2BFD727L4W6845133519F3lD6");
            packageReqHandler.SetParameter("sign", sign);	                    //签名
            ...
            string cert = @"E:\HKfuwushang\apiclient_cert.p12";
            //私钥（在安装证书时设置）
            string password = "1309832401";
            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(CheckValidationResult);
            //调用证书
            X509Certificate2 cer = new X509Certificate2(cert, password, X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.MachineKeySet);
